...
import { Search, ShoppingCart, User, LogOut, ChevronDown, UserCog, Package, Tags } from 'lucide-react'; // Added Tags icon
...
export default function Navbar() {
  ...
  const handleLogout = () => {
    ...
    // Nếu chuyển về trang chủ, trang chủ sẽ tự động gọi useAuth và Navbar sẽ render lại đúng trạng thái.
    router.push('/'); 
    // Hoặc nếu muốn chuyển thẳng về trang đăng nhập: router.push('/auth');
  };
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          ...
          {isLoading ? (
            ...
            // ĐÃ ĐĂNG NHẬP: Hiển thị icon với Dropdown menu
                ...
                >
                  {isAdmin && (
                    ...
                    <Link 
                      ...
                      <Link 
                        href="/admin/manager-category" // <-- ĐÃ SỬA: Dùng đường dẫn mới
            ...
            // CHƯA ĐĂNG NHẬP: Chuyển hướng thẳng đến trang /auth
